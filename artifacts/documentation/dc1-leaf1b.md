...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | OOB_MANAGEMENT | oob | MGMT | fd00:6265:b424:a8b8::1:4/64 | fd00:6265:b424:a8b8::1 |
...
interface Management1
   ...
   ipv6 enable
   ipv6 address fd00:6265:b424:a8b8::1:4/64
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_server1_eth2 | *trunk | *11,21,100-101 | *4092 | *- | 1 |
...
| Loopback10 | DIAG_VRF_Production | Production | 10.255.10.4/32 |
| Loopback20 | DIAG_VRF_Development | Development | 10.255.20.4/32 |
...
| Vlan3009 |  Production  |  10.255.1.97/31  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Development  |  10.255.1.97/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.96 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Development | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.1.96 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Production | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| Development | 10.255.0.4:20 | connected |
| Production | 10.255.0.4:10 | connected |
...
| -------------- | ----------------------- | ----------------------- |
| Development | 10.255.20.4 | - |
| Production | 10.255.10.4 | - |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Development address 10.255.20.4
ip address virtual source-nat vrf Production address 10.255.10.4
```
